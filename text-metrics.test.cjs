...
const MACHINE_RU = `Кроме того, в современном мире цифровая трансформация играет ключевую роль в развитии. Таким образом, осуществляется оптимизация процессов и повышается эффективность деятельности организации. Возможно, в целом это позволяет достичь повышения производительности труда.

Кроме того, компания достигла роста выручки за счёт оптимизации процессов. Таким образом, была достигнута оптимизация затрат и повышена эффективность работы. Как правило, это приводит к улучшению показателей деятельности организации.`;
