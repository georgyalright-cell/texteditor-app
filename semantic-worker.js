"use strict";
importScripts("./meaning-guard.js?v=47");
importScripts("./revision-quality.js?v=47");
importScripts("./model-progress.js?v=47");
...
async function load() {
  if (extractor) return;
  const { pipeline, env } = await import("./vendor/transformers/transformers.web.min.mjs?v=47");
