"use strict";
importScripts("./meaning-guard.js?v=54");
importScripts("./revision-quality.js?v=54");
importScripts("./model-progress.js?v=54");
...
async function load() {
  if (extractor) return;
  const { pipeline, env } = await import("./vendor/transformers/transformers.web.min.mjs?v=54");
