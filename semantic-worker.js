"use strict";
importScripts("./meaning-guard.js?v=53");
importScripts("./revision-quality.js?v=53");
importScripts("./model-progress.js?v=53");
...
async function load() {
  if (extractor) return;
  const { pipeline, env } = await import("./vendor/transformers/transformers.web.min.mjs?v=53");
