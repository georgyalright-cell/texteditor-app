"use strict";
importScripts("./meaning-guard.js?v=55");
importScripts("./revision-quality.js?v=55");
importScripts("./model-progress.js?v=55");
...
async function load() {
  if (extractor) return;
  const { pipeline, env } = await import("./vendor/transformers/transformers.web.min.mjs?v=55");
