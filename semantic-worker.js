"use strict";
importScripts("./meaning-guard.js?v=49");
importScripts("./revision-quality.js?v=49");
importScripts("./model-progress.js?v=49");
...
async function load() {
  if (extractor) return;
  const { pipeline, env } = await import("./vendor/transformers/transformers.web.min.mjs?v=49");
