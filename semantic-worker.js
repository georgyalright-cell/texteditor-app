"use strict";
importScripts("./meaning-guard.js?v=44");
importScripts("./revision-quality.js?v=44");
importScripts("./model-progress.js?v=44");
...
async function load() {
  if (extractor) return;
  const { pipeline, env } = await import("./vendor/transformers/transformers.web.min.mjs?v=44");
