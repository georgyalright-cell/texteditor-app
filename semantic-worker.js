"use strict";
importScripts("./meaning-guard.js?v=48");
importScripts("./revision-quality.js?v=48");
importScripts("./model-progress.js?v=48");
...
async function load() {
  if (extractor) return;
  const { pipeline, env } = await import("./vendor/transformers/transformers.web.min.mjs?v=48");
