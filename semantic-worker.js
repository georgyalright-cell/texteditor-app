"use strict";
importScripts("./meaning-guard.js?v=56");
importScripts("./revision-quality.js?v=56");
importScripts("./model-progress.js?v=56");
...
async function load() {
  if (extractor) return;
  const { pipeline, env } = await import("./vendor/transformers/transformers.web.min.mjs?v=56");
