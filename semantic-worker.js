"use strict";
importScripts("./meaning-guard.js?v=45");
importScripts("./revision-quality.js?v=45");
importScripts("./model-progress.js?v=45");
...
async function load() {
  if (extractor) return;
  const { pipeline, env } = await import("./vendor/transformers/transformers.web.min.mjs?v=45");
