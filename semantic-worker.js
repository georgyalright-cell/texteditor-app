"use strict";
importScripts("./meaning-guard.js?v=46");
importScripts("./revision-quality.js?v=46");
importScripts("./model-progress.js?v=46");
...
async function load() {
  if (extractor) return;
  const { pipeline, env } = await import("./vendor/transformers/transformers.web.min.mjs?v=46");
