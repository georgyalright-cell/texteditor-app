"use strict";
importScripts("./meaning-guard.js?v=52");
importScripts("./revision-quality.js?v=52");
importScripts("./model-progress.js?v=52");
...
async function load() {
  if (extractor) return;
  const { pipeline, env } = await import("./vendor/transformers/transformers.web.min.mjs?v=52");
