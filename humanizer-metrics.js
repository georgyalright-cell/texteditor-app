(function attachHumanizerMetrics(root, factory) {
  ...
  const CLICHE_RU = [
    "важно отметить", "стоит подчеркнуть", "необходимо отметить",
    "нельзя не отметить", "таким образом", "кроме того", "более того",
    "в связи с этим", "следует сказать", "в заключение", "подводя итог",
    "можно сделать вывод", "играет ключевую роль", "не подлежит сомнению",
    "следует отметить", "в современном мире", "на сегодняшний день",
    "трудно переоценить", "неотъемлемой частью", "широкий спектр",
  ];
